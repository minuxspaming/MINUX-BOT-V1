...
async value (status) {
        ...
        // <iq to="s.whatsapp.net" type="set" xmlns="status" id="21168.6213-69"><status>"Hi, A IM MINUX BOT AI "</status></iq>
    }
},
        sendStickerFromUrl: {
...
let pathFile1 = await writeExif(media, { packname: options.packname ? options.packname : 'MINUX BOT AI', author: options.author ? options.author : '', categories: options.categories ? options.categories : [] })
