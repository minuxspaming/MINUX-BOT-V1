...
handler.all = async function (m) {
  ...
  let fotonyu = "https://files.catbox.moe/5mxmik.jpg";
  let logo = "https://files.catbox.moe/5mxmik.jpg"; // define logo aquí
  let namebot = "MINUX BOT LITE AI";
  let sig = "https://instagram.com/minux_rida";
  ...
  try {
    ...
    global.emror = "https://files.catbox.moe/5mxmik.jpg";
    ...
    global.kontak2 = [
      [
        owner[0],
        await conn.getName(owner[0] + "212656970357@s.whatsapp.net"),
        "MINUX BOT AI",
        "https://whatsapp.com",
        true,
      ],
    ...
    global.adReply = {
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: "https://t.me/minux_rida",
          serverMessageId: 103,
          newsletterName: `MINUX BOT LITE AI    |   هيا نحو النجاح 🧑‍🏫`,
        },
        externalAdReply: {
          title: namebot,
          body: global.ucapan,
