...
*BOT MINUX Bot* is a smart, multi-purpose WhatsApp bot that allows media downloading, group management, searching, translation, and image/video processing. It was created by *minux Ouafy*, a tech enthusiast who enjoys modifying codes, and shares his ideas and projects on Instagram: 📸 instagram.com/minux_rida`
  
  await conn.sendMessage(m.chat, {
    image: { url: 'https://files.catbox.moe/5mxmik.jpg' },
    gifPlayback: true,
    caption,
    footer: '`MINUX Ai - 2025`',
