async function handler(m, { conn, text }) {
    try {
        ...
        try {
            ...
            ppuser = 'https://files.catbox.moe/5mxmik.jpg';
        }
        ...
        const ctx = {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: idsal,
                serverMessageId: 20,
                newsletterName: 'BOT MINUX Ai | أسطورة البوتات '
            },
            externalAdReply: {
                title: pushname,
                body: `BOT MINUX runtime is active.| سيلانا رهن الاشارة`,
                thumbnailUrl: ppuser,
                mediaType: 1,
                sourceUrl: 'https://t.me/minux_rida'
            }
        };
